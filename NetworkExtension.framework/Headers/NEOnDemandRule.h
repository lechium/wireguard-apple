...
typedef NS_ENUM(NSInteger, NEOnDemandRuleInterfaceType) {
	...
	NEOnDemandRuleInterfaceTypeAny API_AVAILABLE(macos(10.11), ios(9.0)) API_UNAVAILABLE(watchos) __WATCHOS_PROHIBITED = 0,
	...
	NEOnDemandRuleInterfaceTypeWiFi API_AVAILABLE(macos(10.11), ios(8.0)) API_UNAVAILABLE(watchos) __WATCHOS_PROHIBITED = 2,
	/*! @const NEOnDemandRuleInterfaceTypeCellular Cellular */
	NEOnDemandRuleInterfaceTypeCellular API_AVAILABLE(ios(8.0)) API_UNAVAILABLE(macos) __WATCHOS_PROHIBITED = 3,
} API_AVAILABLE(macos(10.11), ios(8.0)) API_UNAVAILABLE(watchos) __WATCHOS_PROHIBITED;
 ...
 */
@property (readonly) NEOnDemandRuleAction action API_AVAILABLE(macos(10.11), ios(8.0)) API_UNAVAILABLE(watchos) __WATCHOS_PROHIBITED;
 ...
 */
@property (copy, nullable) NSArray<NSString *> *DNSSearchDomainMatch API_AVAILABLE(macos(10.11), ios(8.0)) API_UNAVAILABLE(watchos) __WATCHOS_PROHIBITED;
 ...
 */
@property (copy, nullable) NSArray<NSString *> *DNSServerAddressMatch API_AVAILABLE(macos(10.11), ios(8.0)) API_UNAVAILABLE(watchos) __WATCHOS_PROHIBITED;
 ...
 */
@property NEOnDemandRuleInterfaceType interfaceTypeMatch API_AVAILABLE(macos(10.11), ios(8.0)) API_UNAVAILABLE(watchos) __WATCHOS_PROHIBITED;
 ...
 */
@property (copy, nullable) NSArray<NSString *> *SSIDMatch API_AVAILABLE(macos(10.11), ios(8.0)) API_UNAVAILABLE(watchos) __WATCHOS_PROHIBITED;
 ...
 */
@property (copy, nullable) NSURL *probeURL API_AVAILABLE(macos(10.11), ios(8.0)) API_UNAVAILABLE(watchos) __WATCHOS_PROHIBITED;
 ...
 */
@property (copy, nullable) NSArray<NEEvaluateConnectionRule *> *connectionRules API_AVAILABLE(macos(10.11), ios(8.0)) API_UNAVAILABLE(watchos) __WATCHOS_PROHIBITED;
 ...
 */
- (instancetype)initWithMatchDomains:(NSArray<NSString *> *)domains andAction:(NEEvaluateConnectionRuleAction)action API_AVAILABLE(macos(10.11), ios(8.0)) API_UNAVAILABLE(watchos) __WATCHOS_PROHIBITED;

/*!
 * @property action
 * @discussion The action to take if the properties of the network connection being established match the rule.
 */
@property (readonly) NEEvaluateConnectionRuleAction action API_AVAILABLE(macos(10.11), ios(8.0)) API_UNAVAILABLE(watchos) __WATCHOS_PROHIBITED;
 ...
 */
@property (readonly) NSArray<NSString *> *matchDomains API_AVAILABLE(macos(10.11), ios(8.0)) API_UNAVAILABLE(watchos) __WATCHOS_PROHIBITED;
 ...
 */
@property (copy, nullable) NSArray<NSString *> *useDNSServers API_AVAILABLE(macos(10.11), ios(8.0)) API_UNAVAILABLE(watchos) __WATCHOS_PROHIBITED;
