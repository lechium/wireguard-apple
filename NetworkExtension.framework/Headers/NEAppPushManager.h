...
NEAPPPUSH_EXPORT NSErrorDomain const NEAppPushErrorDomain API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos) __WATCHOS_PROHIBITED;
...
} API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos) __WATCHOS_PROHIBITED;
 ...
 */
@property (copy) NSArray<NSString *> *matchSSIDs API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos) __WATCHOS_PROHIBITED;
 ...
 */
@property (copy) NSDictionary<NSString *, id> *providerConfiguration API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos) __WATCHOS_PROHIBITED;

/*!
 * @property providerBundleIdentifier
 * @discussion A string containing the bundle identifier of the NEAppPushProvider.
 */
@property (copy, nullable) NSString *providerBundleIdentifier API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos) __WATCHOS_PROHIBITED;
 ...
 */
+ (void)loadAllFromPreferencesWithCompletionHandler:(void (^)(NSArray<NEAppPushManager *> * __nullable managers, NSError * __nullable error))completionHandler API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos) __WATCHOS_PROHIBITED;
 ...
 */
- (void)loadFromPreferencesWithCompletionHandler:(void (^)(NSError * __nullable error))completionHandler API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos) __WATCHOS_PROHIBITED;
 ...
 */
- (void)removeFromPreferencesWithCompletionHandler:(void (^)(NSError * __nullable error))completionHandler API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos) __WATCHOS_PROHIBITED;
 ...
 */
- (void)saveToPreferencesWithCompletionHandler:(void (^)(NSError * __nullable error))completionHandler API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos) __WATCHOS_PROHIBITED;

/*!
 * @property localizedDescription
 * @discussion A string containing a description of the app push manager.
 */
@property (copy, nullable) NSString *localizedDescription API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos) __WATCHOS_PROHIBITED;
 ...
 */
@property (getter=isEnabled) BOOL enabled API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos) __WATCHOS_PROHIBITED;

/*!
 * @property active
 * @discussion If set to YES, it indicates the associated configuration is in use. Use KVO to watch for changes.
 */
@property (readonly, getter=isActive) BOOL active API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos) __WATCHOS_PROHIBITED;
...
*/
- (void)appPushManager:(NEAppPushManager *)manager didReceiveIncomingCallWithUserInfo:(NSDictionary *)userInfo API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos) __WATCHOS_PROHIBITED;
