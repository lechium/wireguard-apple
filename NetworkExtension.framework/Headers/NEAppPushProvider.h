 ...
 */
@property (readonly, nullable) NSDictionary<NSString *, id> *providerConfiguration API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos) __WATCHOS_PROHIBITED;
 ...
 */
- (void)startWithCompletionHandler:(void (^)(NSError * __nullable error))completionHandler API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos) __WATCHOS_PROHIBITED;
 ...
 */
- (void)stopWithReason:(NEProviderStopReason)reason completionHandler:(void (^)(void))completionHandler API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos) __WATCHOS_PROHIBITED;
...
*/
- (void)reportIncomingCallWithUserInfo:(NSDictionary * _Nonnull)userInfo API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos) __WATCHOS_PROHIBITED;
 ...
 */
- (void)handleTimerEvent API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos) __WATCHOS_PROHIBITED;
